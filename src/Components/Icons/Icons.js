    ...
    return (
        <>
            <a
                ...
                target="_blank"
                rel="noreferrer" className='Footer__icons_link'
            >
                <object type="image/svg+xml" data={ InstagramIcon } className='Footer__icons'>
            ...
            <a
                ...
                rel="noreferrer" className='Footer__icons_link'
            >
                <object type="image/svg+xml" data={ YoutubeIcon } className='Footer__icons'>
                    Upgrade Your browser to see this.
        </object>
            </a>
            <a
                ...
                rel="noreferrer" className='Footer__icons_link'
            >
                <object type="image/svg+xml" data={ PodcastIcon } className='Footer__icons'>
                    Upgrade Your browser to see this.
        </object>
            </a>
            <a
                ...
                rel="noreferrer" className='Footer__icons_link'
            >
                <object type="image/svg+xml" data={ LinkedIcon } className='Footer__icons'>
                    Upgrade Your browser to see this.
        </object>
            </a>
        </>
