...
export default class BrusherClass {
  /**
  ...
  constructor(options = {}) {
    ...
    innerBgEl.style = `height: 100%; width: 100%; top: 0px; left: 0; position: absolute;`;
    wrapperEl.appendChild(innerBgEl);
    this.domNode = innerBgEl;
    this.domNode.style.zIndex = 3;
  ...
  loadSelectedImage() {
    ...
    // this.image.src = require("/" + this.options.image);
    this.image.src = homepage;
  ...
  drawTail() {
    ...
    this.drawCanvasContext.drawImage(this.brushCanvas, 1, 1);
